...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloAppUsername()).thenReturn("/members/lukaszczapraga");
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/lukaszczapraga?key=test&token=test&fields=name,id&lists=all");
