...
@Service
public class MailCreatorSchedulerService {
    ...
    public String buildSchedulerEmail(String message) {
        ...
        schedulerContext.setVariable("goodbye_message", "Have a great day!");
        ...
        return templateEngine.process("mail/scheduler-info", schedulerContext);
    }
}
